...
<html>
  ...
  <body onload="trColor(); ">
  	<div class="title">新增用户</div>
		<div class="tbDiv">
			<form action="userAndRole/user/saveUser.action" method="post">
			<table id="tUser" class="tUser">
				<tr>
					<td class="tTitle">账号</td>
					<td class="tInput">
					<input class="inCss" type="text" id="username" name="username" value=""/>
					</td>
				...
				<tr>
					...
					<td class="tInput">
					<input class="inCss" type="text" id="pwd" name="pwd" value=""/>
					</td>
				...
				<tr>
					...
					<td class="tInput">
					<input class="inCss" type="text" id="uName" name="uName" value=""/>
					</td>
				...
				<tr>
					...
					<td class="tInput">
						<input type="radio" id="enStatus" name="enStatus" value="1"/>启用
						<input type="radio" id="enStatus1" name="enStatus" value="0" checked="checked"/>不启用
					</td>
