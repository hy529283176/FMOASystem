...
<html>
  ...
  <body onload="trColor(); ">
  	<div class="title">更新科目</div>
		<div class="tbDiv">
			<form action="xitongguanli/update/updateSubject.action" method="post">
			<table id="tUser" class="tUser">
				<tr>
					<td class="tTitle">上级科目</td>
					<td class="tInput"><input style="background-color:#ccc;" readonly="readonly" class="inCss" type="text" id="super_acSub_id" name="super_acSub_id" value="${accountSub.super_id}"/></td>
					<td class="errCss"><span class="errId"></span></td>
				</tr>
				
				<tr>
					<td class="tTitle">科目编号</td>
					<td class="tInput"><input style="background-color:#ccc;" readonly="readonly" class="inCss" type="text" id="acSub_id" name="acSub_id" value="${accountSub.acSub_id}"/></td>
					<td class="errCss"><span class="errId"></span></td>
				</tr>
		...
		<script type="text/javascript">
							$(function(){
								var rdb1 = document.getElementById("balanceDirection");
								var rdb2 = document.getElementById("balanceDirection1");
								if(${accountSub.balanceDirection}=="借"){
									rdb1.checked = true;
									rdb2.checked = false;
								}else{
									rdb1.checked = false;
