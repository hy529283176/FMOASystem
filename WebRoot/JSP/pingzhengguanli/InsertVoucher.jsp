  ...
  <body>
  	...
  	<form action="pingzhengguanli/InsertVoucher/SaveVouchert.action" id="voucherForm" method="post" onsubmit="return saveVoucher();">
		<div class="btnHeader">
					...
					<a style="height:30px;width: 120px;display:  block;float: right;text-align: center;text-decoration: none;padding-top: 8px;" href="pingzhengguanli/getVoucher/auditVoucherList.action?qijian1=&qijian2=&currentPage=1" id="back" name="back" class="saveBtn"><span>返回审核凭证</span></a>
		</div>
